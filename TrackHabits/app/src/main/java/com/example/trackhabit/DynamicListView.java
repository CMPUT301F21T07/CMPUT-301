...
/*
 * PLEASE NOTE THAT THIS CODE IS BORROWED FROM ANDROID OPEN SOURCE PROJECT
 * Youtube video: https://www.youtube.com/watch?v=_BZIvjMgH-Q&ab_channel=AndroidDevelopers
 * NOT IMPLEMENTED YET
 */
...
public class DynamicListView extends ListView {
    ...
    public ArrayList<Habits> mHabitsList;
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(mHabitsList, originalItem, getPositionForView(switchView));
    ...
    public void setHabitsList(ArrayList<Habits> cheeseList) {
        mHabitsList = cheeseList;
    }
