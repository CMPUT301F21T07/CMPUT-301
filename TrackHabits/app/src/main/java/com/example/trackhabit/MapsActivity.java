...
import com.example.trackhabit.databinding.ActivityMapsBinding;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    // A default location (San Francisco) and default zoom to use when location permission is
    // not granted.
    private final LatLng mDefaultLocation = new LatLng(37.4219983, -122.084);
...
//        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        m=mMap.addMarker(new MarkerOptions().position(Default).title("Default"));
    ...
    public void onExitClicked(){
        ...
        Exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                double returnLongitude=m.getPosition().longitude;
                double returnLatitude=m.getPosition().latitude;
                Intent resultIntent=new Intent();
                resultIntent.putExtra("Longitude",returnLongitude);
                resultIntent.putExtra("Latitude",returnLatitude);
    ...
    private void getCurrentPlaceLikelihoods() {
        ...
        @SuppressWarnings("MissingPermission")Task<FindCurrentPlaceResponse> placeResponse = mPlacesClient.findCurrentPlace(request);
    ...
    //The virtual location is set at around San Francisco and not the actual location of the device when testing on emulator
                ...
                locationResult.addOnCompleteListener(this, new OnCompleteListener<Location>() {
                    ...
                    public void onComplete(@NonNull Task<Location> task) {
                        if (task.isSuccessful()) {
                            ...
                            m=mMap.addMarker(new MarkerOptions().position(new LatLng(mLastKnownLocation.getLatitude(),
                                    mLastKnownLocation.getLongitude())).title("Current Location").snippet("Lat : " + mLastKnownLocation.getLatitude() + " , "
            ...
            mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
                ...
                public void onMapClick(LatLng latLng) {
                    ...
                    m=mMap.addMarker(new MarkerOptions()
                        ...
                        m.setSnippet("Lat : " + latLng.latitude + " , "
                                + "Long : " + latLng.longitude);
                        System.out.println("Test Marker Latitude");
                        System.out.println(m.getPosition().latitude);
                    }
